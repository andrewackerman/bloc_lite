...
import 'package:simple_bloc_todo/screens/home/home_screen_controller.dart';
  ...
  Widget build(BuildContext cxt) {
    return InheritedBloc(
      ...
      child: BlocWidget(
        ...
        builder: (_, __) => BlocStateWidget<TodoController, TodoState>.inherited(
          context: cxt,
          builder: (_, todoBloc, todoState) => Scaffold(
            ...
            body: SafeArea(
              child: controller.activeTab == AppTab.todos
                ? TodoList(
                  ...
                  onTodoItemDismissed: (todo)
                    => controller.onTodoItemDismissed(todoBloc, todo),
                  onTodoItemCheckboxChanged: (todo, value)
                    => controller.onTodoItemCheckboxChanged(todoBloc, todo, value),
                )
                : StatsCounter(),
            ),
            ...
            bottomNavigationBar: BottomNavigationBar(
              currentIndex: controller.activeTab == AppTab.todos ? 0 : 1,
